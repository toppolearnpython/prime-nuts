...
/>
              ...
              <p className="text-gray-600">MRP: {product.price}<span className="ml-2 text-gray-500">({product.weight})</span></p>
              <p className="text-green-600 font-bold mt-1"> Current Price: {product.currentPrice}</p>
              <button
